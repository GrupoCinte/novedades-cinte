...
const MODULE_PREFIXES = ['/admin/novedades', '/admin/conciliaciones', '/admin/comercial', '/admin/capital-humano', '/admin/contratacion', '/admin/onboarding', '/admin/directorio', '/admin/atraccion-talento'];
