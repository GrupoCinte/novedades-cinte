...
test('EXPIRED_MONTH julio no arrastra novedades de mayo ya aprobadas en mayo', async () => {
    const novedadRows = [
        {
            ...
            aprobado_en: new Date('2026-05-22T12:00:00Z')
        },
        {
            id: '3469213c-7840-4d03-98cb-2af8bade2bef',
            cedula: '1069735318',
            tipo_novedad: 'Incapacidad',
            monto_cop: '100',
            cantidad_horas: 1,
            ...
            fecha_inicio: '2026-05-15',
            fecha_fin: '2026-05-15',
            aprobado_en: new Date('2026-05-19T12:00:00Z')
        },
        {
            id: '374bc1af-7121-4dc4-b85b-1bf80ad63d4b',
            cedula: '1069735318',
            tipo_novedad: 'Permiso compensatorio en tiempo',
            monto_cop: null,
            cantidad_horas: 4,
            unidad: 'horas',
            modalidad: null,
            ...
            aprobado_en: new Date('2026-06-17T12:00:00Z')
        }
    ];
    const pool = {
        query: async (sql) => {
            const s = String(sql);
            if (s.includes('conciliaciones_facturacion_historial')) return { rows: [] };
            if (s.includes('FROM novedades')) return { rows: novedadRows };
            return { rows: [] };
        }
    };
    const deps = { pool, normalizeCedula, canRoleViewType };
