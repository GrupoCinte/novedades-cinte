...
const MODULE_PREFIXES = ['/admin/novedades', '/admin/conciliaciones', '/admin/comercial', '/admin/capital-humano', '/admin/contratacion', '/admin/onboarding', '/admin/directorio'];
 ...
 */
export default function AdminModuleSidebarBrand({
    variant,
    isLight,
    asideHeaderBorder,
    endAction,
        ...
        <div className={`flex shrink-0 items-start justify-between gap-2 px-4 py-3 sm:px-5 ${asideHeaderBorder}`}>
            ...
            */}
            <div className="min-w-0 flex-1 overflow-hidden pr-1">
                ...
                {moduleContext && variant !== 'rail-collapsed' ? (
                    <div className="mt-2 space-y-0.5">{moduleContext}</div>
                ) : null}
            </div>
