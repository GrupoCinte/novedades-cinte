...
| [patron-filtros-desplegable-multiple.md](./patron-filtros-desplegable-multiple.md) | Patrón UX de filtros de listado (desplegable múltiple, barra liviana, chips). Replicar en todo el portal | Devs / UX |
