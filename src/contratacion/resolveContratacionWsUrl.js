 ...
 *
 * @param {{ viteUrl?: string|null, configUrl?: string|null, host?: string, proto?: string }} opts
 * @returns {string} URL base sin query (sin ticket)
 */
function resolveContratacionWsUrl(opts = {}) {
    ...
    const isSecure = protoRaw === 'https:' || protoRaw === 'wss:' || protoRaw === 'https' || protoRaw === 'wss';
 ...
 * @returns {string}
 */
function buildContratacionWsConnectUrl(baseUrl, ticket) {
