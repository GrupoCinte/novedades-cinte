...
const COLABORADORES_EXTENDED_COLUMNS = [
    ...
    { key: 'induccion', sqlType: 'TEXT', label: 'Inducción' },
    { key: 'reinduccion', sqlType: 'TEXT', label: 'Reinducción' },
    { key: 'iso_9001_contextualizacion', sqlType: 'TEXT', label: 'ISO 9001' },
    { key: 'sgsti_descripcion', sqlType: 'TEXT', label: 'SGSI / seguridad de la información' },
