...
export default function Dashboard({ token, auth, onLogout }) {
    ...
    const PANEL_POLICY = {
        ...
        /** Alineado con `src/rbac.js` POLICY.cac — todos los tabs del shell novedades + directorio/admin JWT */
                ...
                {activeTab === 'Análisis Avanzado' && canAccessPanel('dashboard') && (
                    <div className={`${dash.novedadesTabShell} pb-20`}>
                        ...
                        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
                            ...
                            <div className={`${dash.card} relative overflow-hidden border-rose-500/20 p-6 min-w-0`}>
                        ...
                        <div className={`${dash.card} p-6 mt-5`}>
