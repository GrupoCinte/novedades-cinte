...
/**
 * Barra superior unificada para las vistas del módulo Onboarding.
 * Replica el patrón de "Gestión de novedades": chip resumen + botón
 * "Filtros avanzados" (toggle del drawer) + input de búsqueda rápida.
 *
 * Props:
 *  - chipLabel: string. Texto del chip resumen ("Sin filtros activos" o "N filtros activos…").
 *  - panelOpen: bool. Si el drawer está abierto (controla el chevron).
 *  - onToggle(): callback al pulsar el botón Filtros avanzados.
 *  - search: string. Valor del input de búsqueda rápida.
 *  - onSearchChange(value): callback al cambiar el input.
 *  - searchPlaceholder: string opcional.
 *  - isLight: bool, controla el tema.
 *  - rightSlot: ReactNode opcional (botones extra a la derecha, p. ej. exportar).
 */
